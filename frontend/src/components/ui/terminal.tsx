...
const tokenColors: Record<TokenType, string> = {
  ...
  flag: "text-[var(--color-primary-soft)]",
...
export function Terminal({
  ...
  useEffect(() => {
    ...
    // The state transition is intentionally synchronized with the terminal's executing phase.
  ...
  return (
    ...
    >
      <div className="overflow-hidden rounded-[var(--radius-md)] border border-[var(--color-border-strong)] bg-[var(--color-bg-soft)] shadow-[var(--shadow-xl)]">
        {/* Title Bar */}
        <div className="flex items-center gap-2 border-b border-[var(--color-border-soft)] bg-[var(--color-surface)] px-4 py-3">
        ...
        >
          {lines.map((line, i) => (
            <div key={i} className="leading-relaxed whitespace-pre-wrap">
              {line.type === "command" ? (
                ...
                <span className="text-[var(--color-text-soft)]">{line.content}</span>
              )}
            </div>
          ))}
          ...
          {phase === "typing" && (
            <div className="leading-relaxed whitespace-pre-wrap">
              ...
              <span className="ml-0.5 inline-block h-4 w-2 bg-[var(--color-primary)] align-middle" />
            </div>
          )}
          ...
          {(phase === "done" ||
            ...
            <div className="leading-relaxed whitespace-pre-wrap">
              ...
              <span
                className={cn(
                  "inline-block h-4 w-2 bg-[var(--color-primary)] align-middle transition-opacity duration-100",
