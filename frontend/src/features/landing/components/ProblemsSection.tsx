...
const codeLines = [
  ...
  { n: 4, content: <span className="text-[var(--color-text-soft)]">seen = {'{}'}</span> },
  {
    n: 5,
    content: (
      <>
  ...
  { n: 6, content: <span className="text-[var(--color-text-soft)]">diff = target - n</span> },
  {
    n: 7,
    content: (
      <>
  ...
  { n: 9, content: <span className="text-[var(--color-text-soft)]">seen[n] = i</span> },
]
...
const workflowItems = [
  { icon: Target, label: 'Problemas curados', value: 'Rutas por tema' },
  { icon: TerminalSquare, label: 'Editor integrado', value: 'Python, Java y C' },
  { icon: Gauge, label: 'Progreso visible', value: 'Aceptación y rating' },
]
...
export function ProblemsSection() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_70%_55%_at_50%_0%,rgba(11,127,195,0.12),transparent_62%),radial-gradient(ellipse_52%_42%_at_88%_28%,rgba(56,189,248,0.08),transparent_58%)]" />
      ...
      <SectionContainer className="py-20 lg:py-28">
        ...
        <div className="grid items-start gap-6 lg:grid-cols-[0.86fr_1.14fr]">
          <div className="space-y-4">
            <div className="rounded-[var(--radius-2xl)] border border-white/[0.08] bg-[rgba(15,23,42,0.54)] p-5 shadow-[var(--shadow-lg)] backdrop-blur-xl">
              <div className="flex items-center gap-3">
                <div className="inline-flex h-10 w-10 items-center justify-center rounded-[var(--radius-xl)] bg-[var(--color-primary-soft)] text-[var(--color-primary)]">
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
                {workflowItems.map((item) => {
                  ...
                  return (
                    <div
                      key={item.label}
                      className="rounded-[var(--radius-xl)] border border-white/[0.07] bg-[rgba(7,18,37,0.62)] p-4 transition duration-300 hover:border-[rgba(11,127,195,0.28)] hover:bg-[rgba(13,24,43,0.82)]"
                    >
                      <Icon
            ...
            <div className="rounded-[var(--radius-2xl)] border border-white/[0.08] bg-[rgba(15,23,42,0.42)] p-5 backdrop-blur-xl">
              ...
              <div className="grid lg:grid-cols-[190px_minmax(230px,0.82fr)_minmax(0,1.18fr)]">
                <aside className="border-b border-white/[0.07] lg:border-b-0 lg:border-r lg:border-white/[0.07]">
                  <div className="border-b border-white/[0.07] p-3">
                    <div className="flex items-center gap-2 rounded-[var(--radius-lg)] border border-white/[0.07] bg-[rgba(2,6,23,0.42)] px-3 py-2">
                ...
                <div className="border-b border-white/[0.07] p-4 lg:border-b-0 lg:border-r lg:border-white/[0.07]">
                  ...
                  <div className="mt-5 rounded-[var(--radius-xl)] border border-white/[0.07] bg-[rgba(2,6,23,0.58)] p-4 font-mono text-[0.6875rem] leading-relaxed text-[var(--color-text-muted)]">
                    <p><span className="text-[var(--color-text-subtle)]">Input: </span>nums = [2, 7, 11, 15]</p>
                    <p><span className="text-[var(--color-text-subtle)]">Target: </span>9</p>
                    <p>
                ...
                <div className="min-w-0">
                  <div className="flex border-b border-white/[0.07]">
                    ...
                    <button
                      type="button"
                      className="inline-flex min-h-11 items-center gap-1.5 px-4 text-xs font-semibold text-[var(--color-success)]"
                    >
                    ...
                    <div className="p-4">
                      <div className="space-y-2">
                        {testCases.map((test) => (
                          <div
                            key={test.input}
                            className="grid grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-3 rounded-[var(--radius-xl)] border border-white/[0.07] bg-[rgba(7,18,37,0.66)] px-3 py-2.5"
                          >
...
function MetricRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex items-center justify-between rounded-[var(--radius-xl)] border border-white/[0.07] bg-[rgba(7,18,37,0.54)] px-3 py-2">
