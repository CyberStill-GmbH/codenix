export function HeroBackground() {
    return (
        <div className="absolute inset-0 -z-10 overflow-hidden" aria-hidden="true">
            {/* Base profunda con identidad azul/naranja */}
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_18%_18%,rgba(11,127,195,0.24),transparent_58%),radial-gradient(ellipse_70%_55%_at_86%_12%,rgba(255,107,0,0.12),transparent_54%),radial-gradient(ellipse_80%_70%_at_50%_100%,rgba(2,6,23,0.96),transparent_72%)]" />

            {/* Aurora premium */}
            <div className="absolute left-1/2 top-[-18rem] h-[44rem] w-[78rem] -translate-x-1/2 rounded-full bg-[linear-gradient(90deg,rgba(11,127,195,0.18),rgba(56,189,248,0.10),rgba(255,107,0,0.09))] opacity-90 blur-3xl motion-safe:animate-[codenix-aurora_18s_ease-in-out_infinite]" />
            ...
            <div className="absolute right-[3%] top-[34%] h-px w-[28rem] rotate-[10deg] bg-gradient-to-r from-transparent via-[rgba(255,107,0,0.14)] to-transparent" />
            ...
            <div className="absolute -right-32 top-8 h-[30rem] w-[30rem] rounded-full bg-[rgba(255,107,0,0.12)] blur-3xl motion-safe:animate-[codenix-orbit-b_24s_ease-in-out_infinite]" />
