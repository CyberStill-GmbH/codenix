...
const socialLinks = [
  ...
  { label: 'WhatsApp', href: 'https://whatsapp.com', Icon: WhatsAppMark },
...
function LinkedInMark(props: SVGProps<SVGSVGElement>) {
  return <svg viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286ZM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065Zm1.782 13.019H3.555V9h3.564v11.452ZM22.225 0H1.771C.792 0 .16.774.16 1.729v20.542C.16 23.2.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003Z" /></svg>
}
...
export function FooterBrand() {
  return (
    <div className={landingTokens.footer.brand}>
      ...
      >
        <span
          className={`h-8 w-8 shrink-0 ${landingTokens.color.logo}`}
      ...
      <nav aria-label="Canales de Codenix" className={landingTokens.footer.socialRow}>
        {socialLinks.map(({ label, href, Icon }) => (
          <a
            ...
            className={cx(landingTokens.footer.socialLink, landingTokens.focus)}
          >
