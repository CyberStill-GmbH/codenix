export const landingTokens = {
  ...
  auth: {
    page: 'grid min-h-screen bg-[var(--color-bg)] text-[var(--color-text)] lg:grid-cols-[60%_40%]',
    brandPanel:
    ...
    brandLogo: 'h-16 w-16 shrink-0 bg-[var(--color-logo-mark)]',
    ...
    main: 'relative flex min-h-screen items-center justify-center overflow-y-auto px-5 py-8 sm:px-8 lg:px-8 xl:px-10',
    mainGlow:
    ...
    footerTextCompact:
      'mt-6 text-center text-sm text-[var(--color-text-muted)]',
    footerLink:
