...
export function AdminProblemActions({
  ...
  const publishLabel = problem.status === 'published' ? 'Retirar publicación' : 'Publicar'
  ...
  return (
    <div className="flex flex-wrap items-center justify-end gap-2">
      ...
      >
        ...
        {isUpdating ? 'Guardando' : publishLabel}
      </button>
    </div>
  )
}
