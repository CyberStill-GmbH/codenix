...
export type ProblemsSearchQueryInput = z.infer<
  typeof problemsSearchQuerySchema
>;
...
export type ProblemIdentifierParamsInput = z.infer<
  typeof problemIdentifierParamsSchema
>;
