...
commentsRoutes.post("/problems/:problemId/comments", asyncHandler(authMiddleware), commentRateLimiter, validate({ params: problemCommentsParamsSchema, body: createCommentSchema }), asyncHandler(commentsController.create));
commentsRoutes.post("/comments/:commentId/vote", asyncHandler(authMiddleware), commentVoteRateLimiter, validate({ params: commentIdParamsSchema, body: voteCommentSchema }), asyncHandler(commentsController.vote));
